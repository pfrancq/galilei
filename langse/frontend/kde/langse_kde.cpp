/*
	...
	A KDE about box for Swedish language - Implementation.
...
static const char *description =
	I18N_NOOP("This is the swedish language plugin using a stemming algorithm based on snowball algorithms.");
...
void About(void)
{
	KAboutData aboutData( "se", I18N_NOOP("Swedish Language"),
