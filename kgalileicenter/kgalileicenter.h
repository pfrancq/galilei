...
/**
  ...
  * display whereby one document can have several views.The MDI child is an instance of KGalileiCenterView,
  * the document an instance of KGalileiCenterDoc.
  * KGalileiCenterApp reimplements the methods that KTMainWindow provides for main window handling and supports
...
class KGalileiCenterApp : public KMainWindow
{
  ...
  public:
    /** construtor of KGalileiCenterApp, calls all init functions to create the application.
  ...
  protected:
     ...
     * @see KGalileiCenterDoc#addView
     * @see KGalileiCenterDoc#openDocument
     * @param doc pointer to the document instance that the view will
     * be connected to.
     */
		void createClient(KGalileiCenterDoc* doc);
  ...
  private:
    ...
    QList<KGalileiCenterDoc> *pDocList;	
