...
-- this file contains all the command to be use to fill the table "users"
--------------------------------------------------------------------------
...
---------------------------------------------------------------------------- 
---------------------------------------------------------------------------- 
-- NEW USERS CAN BE ADD BUT TAKE CARE: EACH NEW ENTRY IN THIS TABLE MUST 
-- SATISFY THE FIXED FIELDS:
-- TABLES USERS:
--	userid , must be different from all existing ones
--	user ,   user nick name
--	pwd ,	
--	fullname,
--	email ,
