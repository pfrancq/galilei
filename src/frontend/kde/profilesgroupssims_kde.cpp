...
void About(void)
{
	KAboutData aboutData( "profilesgroupssims", 0, ki18n("Cosinus Method"),
		"1.0", ki18n("The cosinus method is used to computed the similarities between the groups and profiles."), KAboutData::License_GPL,
