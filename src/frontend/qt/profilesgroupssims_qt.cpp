...
{
	QRAboutDialog dlg("Profiles/Communities Similarities","1.0");
	dlg.setDescription("Method used to compute the similarities using the tensor space model between communities and profiles.");
