...
{
	QRAboutDialog dlg("k-Means Plug-in for Documents","1.0");
	dlg.setDescription("This is a set of k-Means algorithms to cluster documents.");
...
extern "C" bool Configure(GPlugIn* fac)
{
	...
	Ui_Config Ui;
	Ui.setupUi(&Dlg);
	Dlg.setWindowTitle("Configure k-Means for Documents");
