/*
	...
	Turkish language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Turkish Language","1.0");
	dlg.setDescription("This is the Turkish language plug-in using a stemming algorithm based on Snowball.");
