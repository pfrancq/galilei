...
//-----------------------------------------------------------------------------
/**
* The GLangSE class provides a representation for the Romanian language.
* @short Romanian language.
*/
class GLangTR : public GLang
{
	/**
	 * Stemmer.
	 */
...
public:
	...
	/**
	* Constructor of the Turkish language.
	* @param session         Session.
	* @param fac             Factory.
	*/
	GLangTR(GSession* session,GPlugInFactory* fac);
