	...
	: GLang(fac,"French","fr"), Rules1(0), Rules2(0), Rules3(0)
{
	...
	Rules1->InsertPtr(new FrenchPorterRule("�rent","",4 ,-1 ,0));
	...
	Rules1->InsertPtr(new FrenchPorterRule("i�re","",3 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("ete","",2 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("�te","",2 ,-1 ,0));
	...
	Rules1->InsertPtr(new FrenchPorterRule("�tude","",4 ,-1 ,0));
	...
	Rules1->InsertPtr(new FrenchPorterRule("it�e","",3 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("it�","",2 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("t�","",1 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("�e","",1 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("�","",0 ,-1 ,0));
	...
	Rules1->InsertPtr(new FrenchPorterRule("�tudes","",5 ,-1 ,0));
	...
	Rules1->InsertPtr(new FrenchPorterRule("i�res","",4 ,-1 ,0));
	...
	Rules1->InsertPtr(new FrenchPorterRule("e�tes","",4 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("e�mes","",4 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("it�es","",4 ,-1 ,0));
	...
	Rules1->InsertPtr(new FrenchPorterRule("�mes","",3 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("�mes","",3 ,-1 ,0));
	Rules1->InsertPtr(new FrenchPorterRule("�mes","",3 ,-1 ,0));
	...
	Rules1->InsertPtr(new FrenchPorterRule("�s","",1 ,-1 ,0));
...
bool GLangFR::ContainsVowel(const char* kwd)
{
	if(!(*kwd))
		...
		return((IsVowel(*kwd))||(strpbrk(kwd+1,"�eiouy���")));
}
