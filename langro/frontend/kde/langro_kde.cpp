/*
	...
	Romanian language (KDE Part) - Implementation.
...
void About(void)
{
	KAboutData aboutData("ro", 0, ki18n("Romanian Language"),
		"1.0", ki18n("This is the Romanian language plug-in using a stemming algorithm based on Snowball"), KAboutData::License_GPL,
		ki18n("(C) 2001-2011 by the Snowball Project\n(C) 2008-2012 by Pascal Francq"),
