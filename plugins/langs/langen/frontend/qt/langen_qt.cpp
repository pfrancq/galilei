/*
	...
	English Language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("English Language","1.0");
	dlg.setDescription("This is the English language plug-in using the Porter stemming algorithm.");
