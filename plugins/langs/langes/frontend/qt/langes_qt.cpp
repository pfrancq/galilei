/*
	...
	Spanish Language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Spanish Language","1.0");
	dlg.setDescription("This is the Spanish language plug-in using a stemming algorithm based on Snowball.");
