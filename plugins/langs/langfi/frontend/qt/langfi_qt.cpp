/*
	...
	Finnish Language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Finnish Language","1.0");
	dlg.setDescription("This is the Finnish language plug-in using a stemming algorithm based on Snowball.");
