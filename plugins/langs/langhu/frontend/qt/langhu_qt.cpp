/*
	...
	Hugarian language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Hungarian Language","1.0");
	dlg.setDescription("This is the Hungarian language plug-in using a stemming algorithm based on Snowball.");
