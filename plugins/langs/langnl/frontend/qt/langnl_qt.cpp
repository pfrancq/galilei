/*
	...
	Dutch Language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Qutch Language","1.0");
	dlg.setDescription("This is the Dutch language plug-in using a stemming algorithm based on Snowball.");
