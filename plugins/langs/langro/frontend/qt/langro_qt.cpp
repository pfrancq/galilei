/*
	...
	Romanian language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Romanian Language","1.0");
	dlg.setDescription("This is the Romanian language plug-in using a stemming algorithm based on Snowball.");
