/*
	...
	Generic Plug-in for NNGGA - Template Implementation
...
template<class cPlugin,class cObj,class cGroup,class cInst,class cGAGroup>
	NNGGAPlugIn<cPlugin,cObj,cGroup,cInst,cGAGroup>::NNGGAPlugIn(GSession* session,GPlugInFactory* fac,const RString& name,tObjType objtype,tObjType grouptype)
...
//-----------------------------------------------------------------------------
template<class cPlugin,class cObj,class cGroup,class cInst,class cGAGroup>
	bool NNGGAPlugIn<cPlugin,cObj,cGroup,cInst,cGAGroup>::IsCoherent(const cGroup* /*grp*/) const
{
	return(true);
}
...
//-----------------------------------------------------------------------------
template<class cPlugin,class cObj,class cGroup,class cInst,class cGAGroup>
	bool NNGGAPlugIn<cPlugin,cObj,cGroup,cInst,cGAGroup>::IsCoherent(const cGroup* /*grp*/,const cObj* /*sub*/) const
{
	return(true);
}
...
//-----------------------------------------------------------------------------
template<class cPlugin,class cObj,class cGroup,class cInst,class cGAGroup>
	bool NNGGAPlugIn<cPlugin,cObj,cGroup,cInst,cGAGroup>::IsValid(cGroup* /*grp*/)
{
...
//-----------------------------------------------------------------------------
template<class cPlugin,class cObj,class cGroup,class cInst,class cGAGroup>
	template<class cAlgoGroup> void NNGGAPlugIn<cPlugin,cObj,cGroup,cInst,cGAGroup>::ConstructResults(GSession* session,R::RCursor<cAlgoGroup> Sol)
{
	size_t i;
...
//-----------------------------------------------------------------------------
template<class cPlugin,class cObj,class cGroup,class cInst,class cGAGroup>
	void NNGGAPlugIn<cPlugin,cObj,cGroup,cInst,cGAGroup>::RunGrouping(GSession* session,const R::RString& mes)
{
	...
	if(Cout)
		cout<<"Do NNGGA for "<<GetObjType(ObjType,false,true)<<endl;
	...
	InsertObserver(reinterpret_cast<tNotificationHandler>(&NNGGAPlugIn<cPlugin,cObj,cGroup,cInst,cGAGroup>::Gen),"RInst::Generation",&Instance);
	if(Cout)
		cout<<"Init NNGGA"<<endl;
...
//------------------------------------------------------------------------------
template<class cPlugin,class cObj,class cGroup,class cInst,class cGAGroup>
	void NNGGAPlugIn<cPlugin,cObj,cGroup,cInst,cGAGroup>::Gen(const R::RNotification& notification)
{
	if(Cout)
...
//------------------------------------------------------------------------------
template<class cPlugin,class cObj,class cGroup,class cInst,class cGAGroup>
	void NNGGAPlugIn<cPlugin,cObj,cGroup,cInst,cGAGroup>::CreateConfig(void)
{
