/*
	...
	A RTF filter (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("RTF Filter","1.0");
	dlg.setDescription("This is the RTF filter for GALILEI.");
	...
	dlg.addAuthor(QWidget::trUtf8("Nicolas Kumps"),QWidget::trUtf8("developer"));
