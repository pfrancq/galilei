/*
	...
	Danish Language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Danish Language","1.0");
	dlg.setDescription("This is the Danish language plug-in using a stemming algorithm based on Snowball.");
