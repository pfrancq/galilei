/*
	...
	Norwegian language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Norwegian Language","1.0");
	dlg.setDescription("This is the Norwegian language plug-in using a stemming algorithm based on Snowball.");
