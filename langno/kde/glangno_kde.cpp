...
static const char *description =
	I18N_NOOP("This is the norwegian language plugin using a stemming algorithm based on snowball algorithms.");
...
void About(void)
{
	KAboutData aboutData( "no", I18N_NOOP("Norwegian Language"),
