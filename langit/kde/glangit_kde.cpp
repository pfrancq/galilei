...
static const char *description =
	I18N_NOOP("This is the italian language plugin using a stemming algorithm based on snowball algorithms.");
...
void About(void)
{
	KAboutData aboutData( "it", I18N_NOOP("Italian Language"),
