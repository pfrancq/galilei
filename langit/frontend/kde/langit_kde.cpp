/*
	...
	Italian language (KDE Part) - Implementation.
...
void About(void)
{
	KAboutData aboutData( "it", 0, ki18n("Italian Language"),
		"1.5", ki18n("This is the Italian language plugin using a stemming algorithm based on Snowball"), KAboutData::License_GPL,
