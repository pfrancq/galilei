/*
	...
	Italian language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Italian Language","1.0");
	dlg.setDescription("This is the Italian language plug-in using a stemming algorithm based on Snowball.");
