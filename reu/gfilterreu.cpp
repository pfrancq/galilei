...
//---------------------------------------------------------------------------
bool GALILEI::GFilterReu::Analyze(GDocXML* doc) throw(bad_alloc,GException)
{
...
//---------------------------------------------------------------------------
void GALILEI::GFilterReu::InitCharContainer(void)
{
...
//---------------------------------------------------------------------------
void GALILEI::GFilterReu::SkipSpaces(void)
{
...
//---------------------------------------------------------------------------
void GALILEI::GFilterReu::AnalyseBody(void)
{
	RXMLTag* content;
	RXMLTag* act;
...
//---------------------------------------------------------------------------
void GALILEI::GFilterReu::AnalyseHeader(void)
{
	RXMLTag* meta;
...
//---------------------------------------------------------------------------
void GALILEI::GFilterReu::ReadMetaTag(char* params,RXMLTag* /*metaData*/)
{
	char* ptr;
	char delimiter;
...
//---------------------------------------------------------------------------
void GALILEI::GFilterReu::ReplaceCode(void)
{
	char* ptr=Pos+1;
	char tmp[11];
	char* ptr2=tmp;
...
//---------------------------------------------------------------------------
void GALILEI::GFilterReu::NextTag(void)
{
...
//---------------------------------------------------------------------------
void GALILEI::GFilterReu::NextValidTag(void)
{
