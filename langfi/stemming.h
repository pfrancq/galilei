...
namespace stemming
	...
	public:
		...
		virtual void operator()(std::basic_string<Tchar_type, Tchar_traits>& text) = 0;
	protected:
		//R1, R2, RV functions
		void find_r1(const std::basic_string<Tchar_type, Tchar_traits>& text,
			...
			if (start == std::basic_string<Tchar_type, Tchar_traits>::npos)
				{
				//we at least need a vowel somewhere in the word
				m_r1 = text.length();
				return;
				}
		...
		inline void update_r_sections(const std::basic_string<Tchar_type, Tchar_traits>& text)
			{
			if (m_r2 > static_cast<int>(text.length() ) )
				{
				m_r2 = static_cast<int>(text.length() );
				}
			if (m_r1 > static_cast<int>(text.length() ) )
				{
				m_r1 = static_cast<int>(text.length() );
				}
			if (m_rv > static_cast<int>(text.length() ) )
				{
				m_rv = static_cast<int>(text.length() );
				}
			}
		//---------------------------------------------
		...
		inline bool is_suffix(std::basic_string<Tchar_type, Tchar_traits>& text,
					Tchar_type* suffix, size_t suffix_length)
			{
		...
		//-------------------------------------------------
		inline bool is_suffix_in_rv(std::basic_string<Tchar_type, Tchar_traits>& text,
		...
		//-------------------------------------------------
		inline bool is_suffix_in_r1(std::basic_string<Tchar_type, Tchar_traits>& text,
					const Tchar_type* suffix, size_t suffix_length)
			{
			assert(string_util::strlen(suffix) == suffix_length);
			if (suffix_length > text.length() )
		...
		bool delete_if_is_in_r1(std::basic_string<Tchar_type, Tchar_traits>& text,
					const Tchar_type* suffix, size_t suffix_length,
		...
		bool delete_if_is_in_r2(std::basic_string<Tchar_type, Tchar_traits>& text,
					const Tchar_type* suffix, size_t suffix_length,
					bool success_on_find = true)
			{
			assert(string_util::strlen(suffix) == suffix_length);
		...
		bool delete_if_is_in_rv(std::basic_string<Tchar_type, Tchar_traits>& text,
					const Tchar_type* suffix, size_t suffix_length,
					bool success_on_find = true)
			{
			assert(string_util::strlen(suffix) == suffix_length);
		...
		//----------------------------------------------------------
		void unhash_dutch_yi(std::basic_string<Tchar_type, Tchar_traits>& text)
			{
		...
		//----------------------------------------------------------
		void unhash_german_yu(std::basic_string<Tchar_type, Tchar_traits>& text)
			{
			string_util::replace_all(text, LOWER_Y_HASH, 'y');
			string_util::replace_all(text, UPPER_Y_HASH, 'Y');
		...
		//----------------------------------------------------------
		void unhash_y(std::basic_string<Tchar_type, Tchar_traits>& text)
			{
			string_util::replace_all(text, LOWER_Y_HASH, 'y');
			string_util::replace_all(text, UPPER_Y_HASH, 'Y');
			}
		...
		//----------------------------------------------------------
		void unhash_italian_ui(std::basic_string<Tchar_type, Tchar_traits>& text)
			{
			string_util::replace_all(text, LOWER_I_HASH, 'i');
			string_util::replace_all(text, UPPER_I_HASH, 'I');
			string_util::replace_all(text, LOWER_U_HASH, 'u');
