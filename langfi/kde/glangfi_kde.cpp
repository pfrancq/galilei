...
static const char *description =
	I18N_NOOP("This is the finnish language plugin using a stemming algorithm based on snowball algorithms.");
...
void About(void)
{
	KAboutData aboutData( "fi", I18N_NOOP("Finnish Language"),
