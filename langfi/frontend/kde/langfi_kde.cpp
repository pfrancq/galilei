/*
	...
	Finnish Language (KDE Part) - Implementation.
...
void About(void)
{
	KAboutData aboutData( "fi", 0, ki18n("Finnish Language"),
		"1.5", ki18n("This is the Finnish language plug-in using a stemming algorithm based on Snowball"), KAboutData::License_GPL,
		ki18n("(C) 2001-2011 by the Snowball Project\n(C) 2001-2014 by Pascal Francq\n(C) 2001 by David Wartel\n(C) 2001-2008 by the Université Libre de Bruxelles (ULB"),
