/*
	...
	A KDE about box for Finnish language - Implementation.
...
void About(void)
{
	KAboutData aboutData( "fi", 0, ki18n("Finnish Language"),
		"1.0", ki18n("This is the finnish language plugin using a stemming algorithm based on snowball algorithms."), KAboutData::License_GPL,
