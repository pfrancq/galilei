/*
	...
	Swedish language (KDE Part) - Implementation.
...
void About(void)
{
	KAboutData aboutData("sv", 0, ki18n("Swedish Language"),
		"1.5", ki18n("This is the Swedish language plug-in using a stemming algorithm based on Snowball"), KAboutData::License_GPL,
