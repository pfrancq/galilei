/*
	...
	Swedish language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("Swedish Language","1.0");
	dlg.setDescription("This is the Swedish language plug-in using a stemming algorithm based on Snowball.");
