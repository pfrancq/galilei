...
static const char *description =
	I18N_NOOP("This is the spanish language plugin using a stemming algorithm based on snowball algorithms.");
...
void About(void)
{
	KAboutData aboutData( "es", I18N_NOOP("Spanish Language"),
