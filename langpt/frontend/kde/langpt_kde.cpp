/*
	...
	Portuguese language (KDE Part) - Implementation.
...
void About(void)
{
	KAboutData aboutData( "pt", 0, ki18n("Portuguese Language"),
		"1.5", ki18n("This is the Portuguese language plug-in using a stemming algorithm based on Snowball"), KAboutData::License_GPL,
