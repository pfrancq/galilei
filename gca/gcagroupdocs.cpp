...
*/
class GCAGroupDocs : public GCAPlugIn<GGroupDocs,GDoc,GTopic,GCAInstDoc,GCAGroupDoc>
{
	using GCAPlugIn<GGroupDocs,GDoc,GTopic,GCAInstDoc,GCAGroupDoc>::FindParam;
...
public:
	...
	*/
	GCAGroupDocs(GSession* session,GPlugInFactory* fac)
		: GCAPlugIn<GGroupDocs,GDoc,GTopic,GCAInstDoc,GCAGroupDoc>(session,fac,"Documents Grouping",otDoc,otTopic) {}
...
protected:
	...
	*/
	virtual void Run(void) {RunGrouping(Session,"Documents",Session->GetDocs());}
};
