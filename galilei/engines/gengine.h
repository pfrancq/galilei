...
public:
	...
	*/
	GDocFragment* AddResult(GDoc* doc,const GConceptRecord* rec,size_t pos,size_t spos,size_t first,size_t last,double ranking=0.0);
	...
	* @return a pointer to a GDocFragment.
	*/
	GDocFragment* AddResult(size_t docid,const GConceptRecord* rec,size_t spos,size_t pos,size_t first,size_t last,double ranking=0.0);
