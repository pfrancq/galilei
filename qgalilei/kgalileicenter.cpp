...
//-----------------------------------------------------------------------------
QGALILEI* KGALILEICenter::App(0);

//-----------------------------------------------------------------------------
KGALILEICenter::KGALILEICenter(QGALILEI* app)
	: KXmlGuiWindow(0),
...
//	    	return;
//		DestroyDoc=true;
//		QSessionProgressDlg dlg(App,"Loading from Database");
//		if(dlg.Run(new QCreateSession(App,Doc,SessionName)))
//		{
...
{
//	QSessionProgressDlg Dlg(App,"Compute Complete Session");
...
{
//	statusBar()->changeItem(text,1);this
}
...
{
//	QSessionProgressDlg Dlg(App,"Index documents");
...
//	if(Doc)
//	{
//		QSessionProgressDlg Dlg(App,"Analyze Documents");
...
{
//	QSessionProgressDlg Dlg(App,"Compute Topics");
...
{
//	QSessionProgressDlg Dlg(App,"Compute Profiles");
...
{
//	QSessionProgressDlg Dlg(App,"Compute Communities");
...
{
//	QSessionProgressDlg Dlg(App,"Create Ideal Subjects");
...
{
//	QSessionProgressDlg Dlg(App,"Repair Subjects");
...
{
//	QSessionProgressDlg Dlg(App,"Compute Trust");
...
{
//	QSessionProgressDlg Dlg(App,"Compute Suggestions");
...
//		return;
//
//	QSessionProgressDlg Dlg(App,"Tool");
//	Tool=FromQString(Ui.List->item(Ui.List->currentRow())->text());
//	QRunTool* Task(new QRunTool(App,Tool,ToolCat));
//	Dlg.Run(Task);
}
