/*
	...
	Generic Plug-in for NNGGA - Header.
...
//-----------------------------------------------------------------------------
/**
 * The NNGGAPlugIn class provides a representation for a generic plug-in
 * implementing a NNGGA for a specific kind of objects (profiles, documents,
 * etc.).
 * @author Pascal Francq
 * @short Generic NNGGA PlugIn
 */
template<class cPlugin,class cObj,class cGroup,class cInst,class cGAGroup>
	class NNGGAPlugIn : public cPlugin, R::RObject, public RParamsNN
{
protected:
...
public:
	...
	* Constructor.
	*/
	NNGGAPlugIn(GSession* session,GPlugInFactory* fac,const R::RString& name,tObjType objtype,tObjType grouptype);

	/**
	 * Class name.
	 */
	virtual R::RCString GetClassName(void) const {return("NNGGAPlugIn");}
