/*
	...
	German Language (Qt Part) - Implementation.
...
{
	QRAboutDialog dlg("German Language","1.0");
	dlg.setDescription("This is the German language plug-in using a stemming algorithm based on Snowball.");
